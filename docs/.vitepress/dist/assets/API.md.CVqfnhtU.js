import{_ as a,c as i,o as n,ae as t}from"./chunks/framework.CnPnaHem.js";const o=JSON.parse('{"title":"API 模块","description":"","frontmatter":{},"headers":[],"relativePath":"API.md","filePath":"API.md"}'),l={name:"API.md"};function p(e,s,h,k,r,E){return n(),i("div",null,s[0]||(s[0]=[t(`<h1 id="api-模块" tabindex="-1">API 模块 <a class="header-anchor" href="#api-模块" aria-label="Permalink to &quot;API 模块&quot;">​</a></h1><p>API 模块</p><h2 id="syntax-highlighting" tabindex="-1">Syntax Highlighting <a class="header-anchor" href="#syntax-highlighting" aria-label="Permalink to &quot;Syntax Highlighting&quot;">​</a></h2><p>VitePress provides Syntax Highlighting powered by <a href="https://github.com/shikijs/shiki" target="_blank" rel="noreferrer">Shiki</a>, with additional features like line-highlighting:</p><p><strong>Input</strong></p><div class="language-md vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">md</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">\`\`\`js{4}</span></span>
